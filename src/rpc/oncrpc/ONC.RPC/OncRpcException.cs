...
public class OncRpcException : Exception
{
    ...
    /// Renamed from RPC_CANTENCODEARGS (=1).  </para></summary>
    ...
    /// Renamed from RPC_TIMEDOUT (=5).  </para></summary>
    ...
    /// Renamed from RPC_VERSMISMATCH (=6).  </para></summary>
    ...
    /// Renamed from RPC_AUTHERROR (=7). </para></summary>
    ...
    /// Renamed from RPC_PROGUNAVAIL (=8),which maps to Visa32.VISA.VI_ERROR_INV_EXPR.  </para></summary>
    ...
    /// Renamed from RPC_PROGVERSMISMATCH (=9). </para></summary>
    ...
    /// Renamed from RPC_PROCUNAVAIL = 10. </para></summary>
    ...
    /// Renamed from RPC_CANTDECODEARGS = 11. </para></summary>
    ...
    /// Renamed from RPC_SYSTEMERROR = 12. </para></summary>
    ...
    /// are supported. <para>
    /// Renamed from RPC_UNKNOWNPROTO = 17. </para></summary>
    ...
    /// Renamed from RPC_PMAPFAILURE = 14. </para></summary>
    ...
    /// Renamed from RPC_PROGNOTREGISTERED = 15. </para></summary>
    ...
    /// Renamed from RPC_BUFFERUNDERFLOW = 43. </para>
    /// </summary>
    ...
    /// Renamed from RPC_WRONGMESSAGE = 44. </para></summary>
    ...
    /// Renamed from RPC_CANNOTREGISTER = 45. </para></summary>
